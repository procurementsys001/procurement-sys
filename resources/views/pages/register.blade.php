  ...
  <div class="row">
        <form class="col s12">
          ...
          <div class="row">
            ...
            <select>
                <option value="" disabled selected>Choose level of Management</option>
                <option value="1">Lower Management</option>
        ...
        <div class="right-align">
            <a class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">vpn_key</i>Login</a>
            <a class="waves-effect waves-light btn-small"><i class="material-icons left">vpn_key</i>Register</a>
        </div>
        </form>
      </div>
        <!--End login form--->
